package com.maddy.springbootkafkadec2019.kafkaconsumer.error.handler;
...
public class FoodOrderErrorHandler implements ConsumerAwareListenerErrorHandler{
	...
	public Object handleError(Message<?> message, ListenerExecutionFailedException exception, Consumer<?, ?> consumer) {
		log.warn("food order error. Pretending to send to elesticsearch {}, because {}", message.getPayload(),exception.getMessage());
		return null;
	}
